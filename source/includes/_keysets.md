...
<aside class="notice">The PATCH function allows you to update the Workspaces for a Keyset. To activate Workspace restrictions for the Keyset, pass the Workspace ID(s) in the `workspaces` array. To make the Keyset available to the entire Organization, delete the Workspace ID(s).</aside>
